...
allowed_for() {
    case "$1" in
        ...
        level-4-graph-calculus)   echo "derivative_assert graph_carrier graph_relation graph_relation_algebra graph_profile graph_algorithms fractal_graph graph_relational_view" ;;
        ...
        level-6-derivative-structure) echo "derivative_assert graph_carrier graph_relation graph_relation_algebra graph_binary_relation graph_profile graph_algorithms fractal_graph graph_relational_view" ;;
        ...
        level-8-derivative-constitution) echo "derivative_assert graph_carrier graph_relation graph_relation_algebra graph_profile graph_algorithms class_graph_field derivative_constitution_fixture fractal_graph graph_relational_view" ;;
        ...
        level-9-statement)        echo "derivative_assert graph_carrier graph_relation graph_relation_algebra graph_profile graph_algorithms class_graph_field derivative_constitution_fixture fractal_graph graph_relational_view" ;;
