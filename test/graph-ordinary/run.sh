...
# The naming law (doc/coding-standards.md), one implementation shared
# with the pre-commit hook: check_naming.sh refuses modules outside
# the prime namespace, types wearing one, an incomplete or
# misordered OBJECTS, import aliases, get_ declarations, re-exports,
