...
!                                  graph_form, aimed along the edge normal
!                                  at the edge center
...
! graph_form. The headless edge's own point leaves its weight through the
...
module operation_fitted_balance
  ...
  use operation_fit_optimizer , only : fit_optimizer, fit
...
contains
  ...
  ! whatever the caller means by them; the graph_form says what the values
