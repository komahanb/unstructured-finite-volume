...
#
# 2. OPERATORS. view_directed, operation_stencil, operation_family
...
#    operation_family, graph_calculus and operation_fitting, so refusing
...
allowed_for() {
    case "$1" in
        ...
        common/production_discretization_fixture.f90) echo "view_directed operation_stencil operation_family" ;;
        ...
        level-8-constitution) echo "graph_fractal map_set_representation map_set map_label visualization_assert visualization_carriers_fixture visualization_relations_fixture visualization_algebra_fixture structural_renderer_fixture production_discretization_fixture production_pattern_renderer_fixture relation_finitary relation_binary relation_algebra view_directed view_directed_stored operation_stencil operation_family operation_jacobi" ;;
        # ---- L9: the statement, on the same constitution plus the
        #          coefficient view Level 5 earned.
        level-9-statement) echo "graph_fractal map_set_representation map_set map_label visualization_assert visualization_carriers_fixture visualization_relations_fixture visualization_algebra_fixture structural_renderer_fixture valued_renderer_fixture visualization_values_fixture production_discretization_fixture production_pattern_renderer_fixture relation_finitary relation_binary relation_algebra view_directed field_calculus view_directed_stored field_stored operation_stencil operation_family operation_jacobi" ;;
...
if [ "$1" = "--selftest" ]; then
    ...
    refuses level-5-field-calculus operation_family
    ...
    refuses level-6-discretization operation_driver
    ...
    permits common/production_discretization_fixture.f90 operation_family
    refuses common/production_discretization_fixture.f90 operation_driver
    ...
    refuses common/valued_renderer_fixture.f90 operation_family
    ...
    refuses level-7-minimization operation_driver
