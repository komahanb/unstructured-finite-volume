...
allowed_for() {
    case "$1" in
        ...
        level-3-graph)            echo "adjoint_assert graph_fractal map_set_representation map_set map_label map_inclusion relation_finitary relation_algebra relation_binary graph_fractal graph_relational_view" ;;
        # level 4: the profile and the algorithms - which are here to
        # REFUSE an order, not to produce one.
        level-4-graph-calculus)   echo "adjoint_assert graph_fractal map_set_representation map_set map_label map_inclusion relation_finitary relation_algebra relation_binary graph_algorithms graph_fractal graph_relational_view" ;;
        # level 5: values need domains, not graphs - the smallest
        # allowlist above the ground.
        level-5-field-calculus)   echo "adjoint_assert graph_fractal map_set_representation map_set map_inclusion class_graph_field" ;;
        ...
        level-7-minimization)     echo "adjoint_assert graph_fractal map_set_representation map_set map_inclusion operation_action graph_directed_view graph_field_calculus class_graph_field class_graph class_graph_gmres opaque_equation_fixture" ;;
        ...
        level-8-constitution)     echo "adjoint_assert graph_fractal map_set_representation map_set map_label map_inclusion relation_finitary relation_algebra relation_binary operation_action graph_directed_view graph_field_calculus class_graph_field class_graph class_graph_gmres adjoint_constitution_fixture" ;;
        ...
        # the statement.
        level-9-statement)        echo "adjoint_assert graph_fractal map_set_representation map_set map_label map_inclusion relation_finitary relation_algebra relation_binary graph_field_calculus class_graph class_graph_field class_graph_gmres adjoint_constitution_fixture graph_fractal graph_relational_view" ;;
