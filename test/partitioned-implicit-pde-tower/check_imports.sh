...
allowed_for() {
    case "$1" in
        ...
        common/shifted_laplacian_fixture.f90) echo "fractal_graph graph_grammar graph_field_calculus class_graph_field class_graph_differential_operator" ;;
        ...
        common/partitioned_shifted_laplacian_fixture.f90) echo "fractal_graph graph_set_representation graph_set_map graph_label_map graph_inclusion_map graph_grammar graph_field_calculus class_graph class_graph_field class_graph_partitioner class_graph_assembler shifted_laplacian_fixture" ;;
        ...
        level-5-field-calculus) echo "partitioned_pde_assert fractal_graph graph_set_representation graph_set_map graph_label_map graph_inclusion_map graph_grammar graph_field_calculus class_graph class_graph_field class_graph_partitioner class_graph_assembler" ;;
        ...
        level-6-discretization) echo "partitioned_pde_assert shifted_laplacian_fixture fractal_graph graph_set_representation graph_set_map graph_label_map graph_inclusion_map graph_grammar graph_field_calculus class_graph class_graph_field class_graph_partitioner class_graph_assembler class_graph_differential_operator" ;;
        ...
        level-7-minimization) echo "partitioned_pde_assert shifted_laplacian_fixture fractal_graph graph_set_representation graph_set_map graph_grammar graph_field_calculus class_graph class_graph_field class_graph_gmres" ;;
        ...
        level-8-constitution) echo "partitioned_pde_assert shifted_laplacian_fixture partitioned_shifted_laplacian_fixture fractal_graph graph_grammar graph_field_calculus class_graph class_graph_field class_graph_gmres" ;;
        # ---- L9: the statement, consuming Level 8 and the solver.
        level-9-statement) echo "partitioned_pde_assert shifted_laplacian_fixture partitioned_shifted_laplacian_fixture fractal_graph graph_set_representation graph_set_map graph_grammar graph_field_calculus class_graph class_graph_field class_graph_gmres" ;;
