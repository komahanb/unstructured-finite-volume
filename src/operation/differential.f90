...
module operation_differential
  ...
  ! graph_form, weights computed once and walked many times. Neither
  ! learns the other's business.
  !===================================================================!

  type, extends(graph_operation) :: differential
...
contains
  ...
  pure type(differential) function edge_differential_operator &
  ...
  pure type(differential) function vertex_differential_operator &
       & (order, coefficient, coefficients, spacing, spacings, &
  ...
  pure type(differential) function gradient(coefficient, coefficients, &
  ...
  pure type(differential) function interpolation(coefficient, coefficients, &
  ...
  pure type(differential) function divergence(coefficient, coefficients, &
  ...
  pure type(differential) function laplacian(coefficient, coefficients, &
