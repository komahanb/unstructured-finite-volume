...
module operation_reduction
  ...
  use data_graph_field, only : GRAPH_FIELD_REAL, GRAPH_FIELD_COMPLEX
  use data_graph_field, only : GRAPH_FIELD_LOGICAL
  use operation_graph_operation, only : graph_reduction, graph_broadcast
  use data_graph_field, only : graph_functional
  use structure_graph, only : GRAPH_SIDE_VERTEX
  use structure_support   , only : support
  use data_field     , only : plain_field => field
  use data_functional, only : scalar_result => functional
