!=====================================================================!
! DERIVATIVE ACTION TOWER . LEVEL 3 . THE RELATED GRAPH
!
...
! identity - every relation slot resolves to an owned set, and
...
contains
  ...
  ! to an owned set - no equal-sized unequal domain sneaks in.
  !===================================================================!
  ...
  subroutine check_graph_identity(nfail)
    ...
    g2 = unrelated_graph('derivative specimen again', &
         & [declared_set(v), declared_set(o), declared_set(p)])
