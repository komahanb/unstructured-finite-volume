...
module operation_difference_linearization
  ...
  use operation_graph_operation, only : graph_linearization
  ...
  type, extends(graph_linearization) :: difference_linearization
...
end module operation_difference_linearization
