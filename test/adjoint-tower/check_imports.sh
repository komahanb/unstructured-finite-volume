...
allowed_for() {
    case "$1" in
        ...
        level-4-graph-calculus)   echo "adjoint_assert graph_carrier graph_relation graph_relation_algebra graph_binary_relation graph_profile graph_algorithms fractal_graph graph_relational_view" ;;
        ...
        # the statement.
        level-9-statement)        echo "adjoint_assert graph_carrier graph_relation graph_relation_algebra graph_binary_relation graph_grammar class_graph class_graph_field class_graph_gmres adjoint_constitution_fixture fractal_graph graph_relational_view" ;;
