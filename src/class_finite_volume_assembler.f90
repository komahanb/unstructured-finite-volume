...
!=====================================================================!
! Class that does finite volume discretization of the governing
! equations and assembles residual and jacobian matrices for
! linearization.
! 
! Author: Komahan Boopathy
!=====================================================================!

module class_finite_volume_assembler
  ...
  type, extends(assembler) :: FVM

     ! Geoemtry + Physics
     class(mesh)   , allocatable :: grid
     class(physics), allocatable :: system
...
contains
  ...
  type(FVM) function construct(grid, system) result (this)

    class(mesh)   , intent(in) :: grid
    class(physics), intent(in) :: system

    print *, "constructing finite volume assembler"
...
end module class_finite_volume_assembler
