...
allowed_for() {
    case "$1" in
        ...
        level-4-graph-calculus) echo "partitioned_pde_assert chain_carriers_fixture chain_relations_fixture chain_algebra_fixture fractal_graph graph_set_representation graph_set_map graph_label_map graph_inclusion_map graph_directed_view graph_relation graph_relation_algebra graph_binary_relation class_graph class_graph_partitioner" ;;
        ...
        level-5-field-calculus) echo "partitioned_pde_assert fractal_graph graph_set_representation graph_set_map graph_label_map graph_inclusion_map graph_directed_view graph_field_calculus class_graph class_graph_field class_graph_partitioner class_graph_assembler" ;;
