...
allowed_for() {
    case "$1" in
        ...
        level-7-minimization)    echo "calculator_assert fractal_graph graph_set_representation graph_set_map graph_inclusion_map graph_operation_view graph_directed_view graph_field_calculus class_graph_field class_graph graph_minimization class_graph_gmres affine_residual_fixture" ;;
        ...
        level-9-statement)       echo "calculator_assert fractal_graph graph_set_representation graph_set_map graph_inclusion_map graph_relation graph_relation_algebra graph_field_calculus class_graph_field graph_operation_view graph_directed_view class_graph graph_minimization class_graph_gmres arithmetic_constitution_fixture constituted_residual_fixture fractal_graph graph_relational_view" ;;
