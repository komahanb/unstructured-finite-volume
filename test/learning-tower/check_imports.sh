...
allowed_for() {
    case "$1" in
        ...
        level-7-minimization)    echo "learning_assert fractal_graph graph_set_representation graph_set_map graph_inclusion_map graph_grammar graph_ordinary_view graph_field_calculus class_graph_field class_graph class_graph_gmres learning_residual_fixture" ;;
        ...
        level-9-statement)       echo "learning_assert fractal_graph graph_set_representation graph_set_map graph_inclusion_map graph_relation graph_relation_algebra graph_profile graph_algorithms graph_grammar graph_ordinary_view graph_field_calculus class_graph class_graph_field class_graph_gmres learning_constitution_fixture constituted_residual_fixture fractal_graph graph_relational_view" ;;
