...
allowed_for() {
    case "$1" in
        ...
        level-4-graph-calculus)   echo "adjoint_assert graph_fractal map_set_representation map_set map_set_store map_label map_inclusion relation_finitary relation_algebra relation_binary relation_algorithms graph_fractal view_relational" ;;
