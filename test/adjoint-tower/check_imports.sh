...
allowed_for() {
    case "$1" in
        ...
        level-7-minimization)     echo "adjoint_assert fractal_graph graph_set_representation graph_set_map graph_inclusion_map graph_grammar class_graph_field class_graph class_graph_gmres opaque_equation_fixture" ;;
        ...
        level-8-constitution)     echo "adjoint_assert fractal_graph graph_set_representation graph_set_map graph_label_map graph_inclusion_map graph_relation graph_relation_algebra graph_binary_relation graph_grammar class_graph_field class_graph class_graph_gmres adjoint_constitution_fixture" ;;
        ...
        # the statement.
        level-9-statement)        echo "adjoint_assert fractal_graph graph_set_representation graph_set_map graph_label_map graph_inclusion_map graph_relation graph_relation_algebra graph_binary_relation graph_grammar class_graph class_graph_field class_graph_gmres adjoint_constitution_fixture fractal_graph graph_relational_view" ;;
