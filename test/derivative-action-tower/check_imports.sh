...
allowed_for() {
    case "$1" in
        ...
        level-4-graph-calculus)   echo "derivative_assert graph_fractal map_set_representation map_set map_label map_inclusion relation_finitary relation_algebra relation_algorithms graph_fractal view_relational relation_binary" ;;
